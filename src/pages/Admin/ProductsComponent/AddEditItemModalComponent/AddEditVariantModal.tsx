...
export function AddEditVariantModal({
  ...
  function validateVariant(): boolean {
    ...
    if (!variant.variant_stock_latest_movement?.stock_supplier?.trim())
      return false;
    if (
      variant.variant_stock_latest_movement?.stock_adjustment_amount == null ||
          ...
          <>
            <ModalHeader className="flex flex-col gap-1">
              <span className="font-semibold">
                {itemHasVariant ? "Add Variant" : "Set Additional Details"}
              </span>
            </ModalHeader>
            <ModalBody>
              <>
                {itemHasVariant && (
                  <div className="flex flex-row gap-2 items-center">
                    <Input
                      ...
                      isInvalid={isSubmitted && !variant.variant_name?.trim()}
                      label="Variant Name"
                ...
                <div className="flex flex-col gap-2 items-center">
                  <Input
                    ...
                    type="text"
                    value={
                      variant.variant_low_stock_threshold !== undefined
                        ? String(variant.variant_low_stock_threshold)
                        : ""
                    }
                    onValueChange={(v) => {
                      if (v === "") {
                      ...
                      setVariant({
                        ...variant,
                        variant_low_stock_threshold: num,
                      });
                    }}
                  />
                </div>
                ...
                <div className="flex flex-col gap-2 items-center">
                  <Input
                    ...
                    inputMode="decimal"
                    isDisabled={!variant.variant_price_wholesale}
                    isInvalid={
                      isSubmitted &&
                      variant.variant_price_wholesale != null &&
                      (variant.variant_wholesale_item == null ||
                    ...
                    isRequired={!!variant.variant_price_wholesale}
