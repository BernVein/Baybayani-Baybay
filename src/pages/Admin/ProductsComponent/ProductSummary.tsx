  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <Card className="w-full">
          <CardBody className="gap-y-3">
            <span className="text-default-500">TOTAL INVENTORY QUANTITY</span>
            <div className="flex flex-col item-center">
              <div className="flex flex-row items-center justify-between">
                <div className="flex flex-row items-center gap-2">
                  <span className="text-3xl font-bold">{totalInventory}</span>
                </div>
        ...
        <Card className="w-full">
          <CardBody className="gap-y-3">
            <span className="text-default-500">ITEM CATEGORIES</span>
            <div className="flex flex-col item-center">
              <div className="flex flex-row items-center justify-between">
                <div className="flex flex-row items-center gap-2">
              ...
              <div className="flex flex-row gap-1 items-start cursor-pointer">
                <Link isBlock color="foreground" onPress={onOpen}>
