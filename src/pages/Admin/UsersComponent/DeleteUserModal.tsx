...
export function DeleteUserModal({
  isOpenDeleteUser,
  onOpenChangeDeleteUser,
}: {
  isOpenDeleteUser: boolean;
  onOpenChangeDeleteUser: () => void;
}) {
  return (
    <Modal
      disableAnimation
        ...
        {(onClose) => (
          <>
            <ModalHeader className="flex flex-col items-center gap-2 text-center">
              ...
              <h2 className="text-lg font-semibold text-danger">Delete user</h2>
            </ModalHeader>

            <ModalBody className="text-center text-default-600">
              <p className="text-sm leading-relaxed">
                Are you sure you want to remove{" "}
                <span className="font-semibold text-default-800">User 1</span>
              </p>
            ...
            <ModalFooter className="flex justify-center gap-3 pt-4">
              ...
              <Button className="px-6 font-semibold" color="danger">
                Delete
              </Button>
            </ModalFooter>
          </>
