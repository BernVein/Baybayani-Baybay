    ...
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
      <Card className="w-full">
        <CardBody className="gap-y-3">
          <span className="text-default-500">TOTAL COMPLETED ORDERS</span>
          <div className="flex flex-col item-center">
            ...
            <span className="text-default-500">+12.5% vs last month</span>
          </div>
        </CardBody>
      ...
      <Card className="w-full">
        <CardBody className="gap-y-3">
          <span className="text-default-500">TOTAL PENDING ORDERS</span>
          <div className="flex flex-col item-center">
            <div className="flex flex-row items-center justify-between">
            ...
            <span className="text-default-500">5 customers waiting</span>
          </div>
        </CardBody>
      ...
      <Card className="w-full">
        <CardBody className="gap-y-3">
          <span className="text-default-500">TOTAL CANCELLED ORDERS</span>
          <div className="flex flex-col item-center">
            <div className="flex flex-row items-center justify-between">
              <div className="flex flex-row items-center gap-2">
            ...
            <span className="text-default-500">+3 vs last month</span>
          </div>
        </CardBody>
