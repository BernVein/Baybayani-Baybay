  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="gap-2 flex flex-row justify-between">
          <span className="text-sm font-semibold w-full">Wholesale Price:</span>
          ...
          {selectedItemVariant?.variant_price_wholesale != null ? (
            ...
            <span className="flex justify-end items-end w-full h-full text-default-400 text-sm italic">
              Not available
            </span>
          )}
        </div>
