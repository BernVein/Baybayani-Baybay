...
export function AlIcon(props: IconSvgProps) {
	return (
		<svg
			fill="none"
			height="1em"
...
export function LockIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
...
export function ShieldIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
...
export function AddToCart(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			data-name="Layer 1"
...
export function Chili(props: IconSvgProps) {
	return (
		<svg
			height="1em"
			viewBox="0 0 48 48"
		...
		>
			<g fill="none" stroke="currentColor" strokeWidth="4">
				<path d="M21.168 16.594c1.648-5.607 8.323-7.928 13.093-4.552c4.126 2.918 4.818 8.766 1.488 12.567l-3.13 3.574a48.8 48.8 0 0 1-19.203 13.4l-3.558 1.369a2.339 2.339 0 0 1-2.294-4.014l2.78-2.208a25.8 25.8 0 0 0 8.705-12.927z" />
				<path d="M29.842 10.684a4.931 4.931 0 1 1 7.768 5.39" />
				<path d="m42 4l-4 4" strokeLinecap="round" />
			</g>
		</svg>
	);
}

export function PoultryLeg(props: IconSvgProps) {
	return (
		<svg
			height="1em"
			viewBox="0 0 32 32"
		...
		>
			<g fill="currentColor">
				<path d="M28.457 20.458a1.95 1.95 0 1 1-3.9 0a1.95 1.95 0 0 1 3.9 0m-4.79-3.699a1.2 1.2 0 1 0 0-2.4a1.2 1.2 0 0 0 0 2.4m-.14 2.259a.86.86 0 1 1-1.72 0a.86.86 0 0 1 1.72 0" />
				<path d="M11.155 2.304a3.885 3.885 0 0 0-6.76 2.122c-.836.102-1.65.48-2.285 1.115l-.006.006l-.006.007c-1.529 1.581-1.47 4.172.23 5.657c1.342 1.178 3.33 1.261 4.771.262l1.22 1.208a3.37 3.37 0 0 0 .964 2.878l1.619 1.609l.002.002c.594.587.853 1.439.699 2.29l-.002.007c-.533 3.065.378 6.34 2.762 8.702c3.907 3.873 10.253 3.796 14.06-.223c3.632-3.844 3.553-9.94-.177-13.692l-.002-.003a9.82 9.82 0 0 0-8.792-2.715c-.823.152-1.646-.09-2.222-.658L15.574 9.23h-.001a3.36 3.36 0 0 0-2.893-.946L11.456 7.07a3.9 3.9 0 0 0-.301-4.767m-1.899 8.49L8.214 9.762l-.002-.002a1.53 1.53 0 0 0-2.096-.05a1.9 1.9 0 0 1-2.47-.002l-.002-.002c-.817-.713-.86-1.977-.114-2.755a1.9 1.9 0 0 1 1.296-.552a1.555 1.555 0 0 0 1.54-1.54a1.9 1.9 0 0 1 .548-1.302l.003-.003a1.885 1.885 0 0 1 2.742.08A1.9 1.9 0 0 1 9.684 6.1c-.54.61-.503 1.527.066 2.096l.003.003l1.049 1.04zm4.904-.148l.002.002l1.66 1.65l.002.002c1.064 1.051 2.56 1.468 3.996 1.202l.005-.001a7.82 7.82 0 0 1 7.004 2.164c2.968 2.987 3.03 7.85.141 10.907a7.83 7.83 0 0 1-11.2.176c-1.894-1.877-2.624-4.481-2.199-6.935c.265-1.467-.176-2.992-1.26-4.065h-.001l-1.618-1.609l-.002-.001a1.37 1.37 0 0 1-.006-1.942l.002-.003l1.53-1.54l.002-.001a1.37 1.37 0 0 1 1.942-.006" />
			</g>
		</svg>
	);
}

export function FruitsOutline(props: IconSvgProps) {
	return (
		<svg
			height="1em"
			viewBox="0 0 48 48"
...
export const EyeSlashFilledIcon = (props: IconSvgProps, className: string) => {
	return (
		<svg
			aria-hidden="true"
			fill="none"
...
export const EyeFilledIcon = (props: IconSvgProps, className: string) => {
	return (
		<svg
			aria-hidden="true"
			fill="none"
...
export function TrashIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function MoreIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function RightArrow(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function LeftArrow(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function PhoneIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
...
export function EyeIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function EyeSlashIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function ProductIconWithX(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function FilterIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function MinusIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
...
export function MoreIconVertical(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function ListBullet(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
...
export function SingleListBullet(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
		...
		>
			<path
				strokeLinecap="round"
				strokeLinejoin="round"
				d="M8.25 12h12M3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"
			/>
		</svg>
	);
}

export function SortIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
...
export function SendIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
...
export function ExcelIcon(props: IconSvgProps, className: string) {
	return (
		<svg
			className={className}
			fill="none"
			...
			{...props}
		>
			<path d="M56 30c0-1.662 1.338-3 3-3h108c1.662 0 3 1.338 3 3v132c0 1.662-1.338 3-3 3H59c-1.662 0-3-1.338-3-3v-32m0-68V30" />

			<rect height="68" rx="3" width="68" x="22" y="62" />

			<path d="M138.79 164.725V27.175" />
			<path d="M56.175 58.792H170" />
			<path d="M170 96H90.328" />
			<path d="M169 133.21H56.175" />

			<path d="M44.5 82l23 28" />
			<path d="M67.5 82l-23 28" />
		</svg>
	);
}
...
export function VegetablesOutline(props: IconSvgProps) {
	return (
		<svg
			height="1em"
			viewBox="0 0 48 48"
...
export const MessageIcon = (props: IconSvgProps, className: string) => (
	<svg
		className={className}
		fill="none"
		stroke="currentColor"
...
export const DashboardIcon = (props: IconSvgProps, className: string) => (
	<svg
		className={className}
		fill="none"
		stroke="currentColor"
...
export const UserIcon = (props: IconSvgProps, className: string) => (
	<svg
		className={className}
		fill="none"
		stroke="currentColor"
...
export const ProductIcon = (props: IconSvgProps, className: string) => (
	<svg
		className={className}
		fill="none"
		stroke="currentColor"
...
export const LogoutIcon = (props: IconSvgProps, className: string) => (
	<svg
		className={className}
		fill="none"
		stroke="currentColor"
...
export const BaybayaniLogo = (props: IconSvgProps, className: string) => (
	<svg
		className={className}
		id="Layer_1"
		version="1.1"
	...
	>
		<path
			d="
        M515.036011,704.147461 
        C534.260864,660.080811 561.008118,621.116516 589.878479,583.496338 
        C621.626526,542.126343 655.026062,502.015900 685.000977,459.295746 
        C702.232239,434.737885 718.773193,409.718506 732.359497,382.889343 
        C733.140198,381.347595 734.548035,379.894440 733.942444,377.813263 
        C731.711609,377.086731 731.018921,378.909149 730.070984,380.119171 
        C695.236816,424.585144 658.633484,467.575592 621.732056,510.323395 
        C594.408020,541.976501 567.391968,573.874084 543.996216,608.657532 
        C525.044434,636.833923 508.544189,666.232483 497.273285,698.384338 
        C496.902313,699.442566 496.305542,700.421753 495.821320,701.422607 
        C493.797272,700.789734 494.116608,699.234619 494.042236,698.051086 
        C492.236206,669.310547 489.178131,640.626770 490.001465,611.764160 
        C491.165924,570.942749 495.876892,530.674622 511.240540,492.462341 
        C524.173340,460.296143 544.428772,433.018585 569.097778,408.779053 
        C590.595581,387.655396 614.939697,370.164886 639.085999,352.379761 
        C666.117798,332.469177 692.060974,311.351349 712.903564,284.703094 
